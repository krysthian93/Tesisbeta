    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent LoginIntent = new Intent(RegisterActivity.this,MenuGeneral.class);
            ...
            public void onClick(View view) {
                ...
                if (pwd.equals(cnf_pwd)) {
                    ...
                    if (val > 0) {
                        ...
                        Toast.makeText(RegisterActivity.this, "Error al registrarce", Toast.LENGTH_SHORT).show();
                    }
